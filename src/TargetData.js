...
class TargetData {
    ...
    static allEventMap = {
        ...
        onScrollTopEnd: tmodel => getEvents().getEventType() === 'scrolltopend' && getEvents().isScrollTopEndHandler(tmodel),
        onScrollLeftEnd: tmodel =>  getEvents().getEventType() === 'scrollleftend' && getEvents().isScrollLeftEndHandler(tmodel),        
